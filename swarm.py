...
class swarm():
    ...
    def swarm_iterator(self):
        ...
        for i in range(self.n_particles):
            # self.particle_misfit, self.particle_performance, self.particle_entropy = particle(x_swarm[i],i) # evaluate
            particle_misfit, particle_performance = self.particle(i) # evaluate , self.particle_entropy

            self.LC_swarm[i] = particle_performance.LC[0]
            self.misfit_swarm[i] = particle_misfit 
            # self.entropy_swarm[i] = self.particle_entropy
