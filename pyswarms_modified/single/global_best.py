...
class GlobalBestPSO(SwarmOptimizer):
    def __init__(
        ...
        options,
        bounds=None,
        # bh_strategy="periodic", this was here originallz 
        bh_strategy ="nearest",
        velocity_clamp=None,
        # vh_strategy="unmodified", this was here orginally
        vh_strategy="adjust",       
        center=1.00,
        ftol=-np.inf,
        init_pos=None,
    ...
    def optimize(self, objective_func, iters, n_processes=None, **kwargs):
        ...
        return (final_best_cost, final_best_pos,swarm)

		
########################BS ADD#####################################
		
class GlobalBestPSO_BS(SwarmOptimizer):
    def __init__(
        self,
        n_particles,
        dimensions,
        ...
        init_pos : numpy.ndarray, optional
            option to explicitly set the particles' initial positions. Set to
            :code:`None` if you wish to generate the particles randomly.
        varmin/ varmax : true values of variables/ parameters that arent scaled 
            that I use for model building
        """
        super(GlobalBestPSO_BS, self).__init__(
            n_particles=n_particles,
            dimensions=dimensions,
            options=options,
            bounds=bounds,
...
def optimize_BS(self, objective_func, iters, n_processes=None, **kwargs):
        """Optimize the swarm for a number of iterations
